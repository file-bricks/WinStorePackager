...
def format_report(report: dict[str, Any]) -> str:
    lines = [
        "Linux-Preflight für WinStorePackager",
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="SDK-freier Linux-Preflight für WinStorePackager-Repositories."
    )
    parser.add_argument(
        "--project-root",
    ...
    report = run_linux_preflight(args.project_root, profile_path=args.profile_path)
    if args.json:
